...
//    public String login(Principal p){
    ...
    public String welcome(Model model, Principal p)
    {
        ...
        model.addAttribute("gotskills",skillsRepository.count());
...
//    }
    ///////////////////////////////////////////////////////////////////////
    // ===== Need to go to this route just ones, before the first registration of a first user of the App
...
//        model.addAttribute("newPerson", p);  /////////??????
    ...
    public String postJob(@Valid @ModelAttribute("newJob") Job job, BindingResult bindingResult, Model model, Principal principal)
    {
        ...
        //=== If the minSalary is higher than maxSalary entered, do not accept this
//        else if(job.getMinSalary()>job.getMaxSalary()){
//            return "addjob";
//        }
...
//
//        Iterable<Person> searchPersonList= personRepository.findAllByByEducationalAchievements_EducationalInstitution(schoolname);
